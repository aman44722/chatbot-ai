...
const TRANSLATIONS = {
  ...
  Bengali: {
    closeTitle: 'চ্যাট বন্ধ করবেন?',
    closeBody: 'আপনার চ্যাট ইতিহাস মুছে যাবে এবং আপনি একটি নতুন কথোপকথন শুরু করবেন। এটি পূর্বাবস্থায় ফেরানো যাবে না।',
    closeCancel: 'বাতিল করুন',
    closeConfirm: 'চ্যাট বন্ধ করুন',
    preChatName: 'শুরু করার আগে, আপনার নাম কী?',
    namePlaceholder: 'আপনার নাম লিখুন...',
    startChat: 'চ্যাট শুরু করুন',
    closedTitle: 'কথোপকথন বন্ধ',
    closedBody: 'এই চ্যাটটি সহায়তা দল দ্বারা বন্ধ করা হয়েছে।',
    reopen: 'চ্যাট পুনরায় খুলুন',
    tapOption: 'চালিয়ে যেতে একটি বিকল্পে ট্যাপ করুন',
    selectSubmit: 'নির্বাচন করুন এবং জমা দিন',
  },
  Marathi: {
    closeTitle: 'चॅट बंद करायची?',
    closeBody: 'तुमचा चॅट इतिहास साफ होईल आणि तुम्ही नवीन संभाषण सुरू कराल. हे पूर्ववत करता येणार नाही.',
    closeCancel: 'रद्द करा',
    closeConfirm: 'चॅट बंद करा',
    preChatName: 'सुरू करण्यापूर्वी, तुमचे नाव काय आहे?',
    namePlaceholder: 'तुमचे नाव प्रविष्ट करा...',
    startChat: 'चॅट सुरू करा',
    closedTitle: 'संभाषण बंद',
    closedBody: 'हे चॅट सहाय्य टीमने बंद केले आहे.',
    reopen: 'चॅट पुन्हा उघडा',
    tapOption: 'पुढे जाण्यासाठी पर्यायावर टॅप करा',
    selectSubmit: 'निवडा आणि सबमिट करा',
  },
  Gujarati: {
    closeTitle: 'ચેટ બંધ કરો?',
    closeBody: 'તમારો ચેટ ઇતિહાસ સાફ થઈ જશે અને તમે નવી વાતચીત શરૂ કરશો. આ પૂર્વવત્ કરી શકાશે નહીં.',
    closeCancel: 'રદ કરો',
    closeConfirm: 'ચેટ બંધ કરો',
    preChatName: 'શરૂ કરતા પહેલા, તમારું નામ શું છે?',
    namePlaceholder: 'તમારું નામ દાખલ કરો...',
    startChat: 'ચેટ શરૂ કરો',
    closedTitle: 'વાતચીત બંધ',
    closedBody: 'આ ચેટ સપોર્ટ ટીમ દ્વારા બંધ કરવામાં આવી છે.',
    reopen: 'ચેટ ફરીથી ખોલો',
    tapOption: 'ચાલુ રાખવા માટે વિકલ્પ પર ટેપ કરો',
    selectSubmit: 'પસંદ કરો અને સબમિટ કરો',
  },
  Tamil: {
    closeTitle: 'அரட்டையை மூடவா?',
    closeBody: 'உங்கள் அரட்டை வரலாறு அழிக்கப்படும் மற்றும் நீங்கள் புதிய உரையாடலைத் தொடங்குவீர்கள். இதை மீளமுடியாது.',
    closeCancel: 'ரத்துசெய்',
    closeConfirm: 'அரட்டையை மூடு',
    preChatName: 'தொடங்குவதற்கு முன், உங்கள் பெயர் என்ன?',
    namePlaceholder: 'உங்கள் பெயரை உள்ளிடவும்...',
    startChat: 'அரட்டையைத் தொடங்கு',
    closedTitle: 'உரையாடல் மூடப்பட்டது',
    closedBody: 'இந்த அரட்டை ஆதரவு குழுவால் மூடப்பட்டுள்ளது.',
    reopen: 'அரட்டையை மீண்டும் திற',
    tapOption: 'தொடர விருப்பத்தைத் தட்டவும்',
    selectSubmit: 'தேர்ந்தெடுத்து சமர்ப்பிக்கவும்',
  },
  Telugu: {
    closeTitle: 'చాట్ మూసివేయాలా?',
    closeBody: 'మీ చాట్ చరిత్ర క్లియర్ చేయబడుతుంది మరియు మీరు కొత్త సంభాషణను ప్రారంభిస్తారు. ఇది రద్దు చేయడం సాధ్యం కాదు.',
    closeCancel: 'రద్దు చేయి',
    closeConfirm: 'చాట్ మూసివేయి',
    preChatName: 'ప్రారంభించే ముందు, మీ పేరు ఏమిటి?',
    namePlaceholder: 'మీ పేరును నమోదు చేయండి...',
    startChat: 'చాట్ ప్రారంభించండి',
    closedTitle: 'సంభాషణ మూసివేయబడింది',
    closedBody: 'ఈ చాట్ సపోర్ట్ టీమ్ ద్వారా మూసివేయబడింది.',
    reopen: 'చాట్ మళ్లీ తెరవండి',
    tapOption: 'కొనసాగించడానికి ఎంపికను నొక్కండి',
    selectSubmit: 'ఎంచుకుని సమర్పించండి',
  },
  Kannada: {
    closeTitle: 'ಚಾಟ್ ಮುಚ್ಚಬೇಕೆ?',
    closeBody: 'ನಿಮ್ಮ ಚಾಟ್ ಇತಿಹಾಸವನ್ನು ಅಳಿಸಲಾಗುತ್ತದೆ ಮತ್ತು ನೀವು ಹೊಸ ಸಂಭಾಷಣೆಯನ್ನು ಪ್ರಾರಂಭಿಸುತ್ತೀರಿ. ಇದನ್ನು ಹಿಂಪಡೆಯಲು ಸಾಧ್ಯವಿಲ್ಲ.',
    closeCancel: 'ರದ್ದುಮಾಡಿ',
    closeConfirm: 'ಚಾಟ್ ಮುಚ್ಚಿ',
    preChatName: 'ಪ್ರಾರಂಭಿಸುವ ಮೊದಲು, ನಿಮ್ಮ ಹೆಸರೇನು?',
    namePlaceholder: 'ನಿಮ್ಮ ಹೆಸರನ್ನು ನಮೂದಿಸಿ...',
    startChat: 'ಚಾಟ್ ಪ್ರಾರಂಭಿಸಿ',
    closedTitle: 'ಸಂಭಾಷಣೆ ಮುಚ್ಚಲಾಗಿದೆ',
    closedBody: 'ಈ ಚಾಟ್ ಅನ್ನು ಬೆಂಬಲ ತಂಡದಿಂದ ಮುಚ್ಚಲಾಗಿದೆ.',
    reopen: 'ಚಾಟ್ ಮರು ತೆರೆಯಿರಿ',
    tapOption: 'ಮುಂದುವರಿಸಲು ಆಯ್ಕೆಯನ್ನು ಟ್ಯಾಪ್ ಮಾಡಿ',
    selectSubmit: 'ಆಯ್ಕೆಮಾಡಿ ಮತ್ತು ಸಲ್ಲಿಸಿ',
  },
  Malayalam: {
    closeTitle: 'ചാറ്റ് അടയ്ക്കണോ?',
    closeBody: 'നിങ്ങളുടെ ചാറ്റ് ഹിസ്റ്ററി മായ്ക്കപ്പെടും, നിങ്ങൾ ഒരു പുതിയ സംഭാഷണം ആരംഭിക്കും. ഇത് പഴയപടിയാക്കാൻ കഴിയില്ല.',
    closeCancel: 'റദ്ദാക്കുക',
    closeConfirm: 'ചാറ്റ് അടയ്ക്കുക',
    preChatName: 'ആരംഭിക്കുന്നതിന് മുമ്പ്, നിങ്ങളുടെ പേരെന്താണ്?',
    namePlaceholder: 'നിങ്ങളുടെ പേര് നൽകുക...',
    startChat: 'ചാറ്റ് ആരംഭിക്കുക',
    closedTitle: 'സംഭാഷണം അടച്ചു',
    closedBody: 'ഈ ചാറ്റ് സപ്പോർട്ട് ടീം അടച്ചിരിക്കുന്നു.',
    reopen: 'ചാറ്റ് വീണ്ടും തുറക്കുക',
    tapOption: 'തുടരുന്നതിന് ഓപ്ഷനിൽ ടാപ്പ് ചെയ്യുക',
    selectSubmit: 'തിരഞ്ഞെടുത്ത് സമർപ്പിക്കുക',
  },
  Punjabi: {
    closeTitle: 'ਚੈਟ ਬੰਦ ਕਰੋ?',
    closeBody: 'ਤੁਹਾਡਾ ਚੈਟ ਇਤਿਹਾਸ ਸਾਫ਼ ਹੋ ਜਾਵੇਗਾ ਅਤੇ ਤੁਸੀਂ ਇੱਕ ਨਵੀਂ ਗੱਲਬਾਤ ਸ਼ੁਰੂ ਕਰੋਗੇ। ਇਸ ਨੂੰ ਵਾਪਸ ਨਹੀਂ ਲਿਆ ਜਾ ਸਕਦਾ।',
    closeCancel: 'ਰੱਦ ਕਰੋ',
    closeConfirm: 'ਚੈਟ ਬੰਦ ਕਰੋ',
    preChatName: 'ਸ਼ੁਰੂ ਕਰਨ ਤੋਂ ਪਹਿਲਾਂ, ਤੁਹਾਡਾ ਨਾਮ ਕੀ ਹੈ?',
